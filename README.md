...
- **Анімація**</br>
Сторінка сайту має різного роду анімацію, реалізовану на JavaScript: підняття вгору по кліку кнопки, поява зображень при скролі, поява зображень з обертанням при скролі, а також вмикання лічильника при скролі.
